package flexUnitTests
{
	...
	public class TestIntegration
	{
		...
		{
			pn.time();
			asyncFun1 = Async.asyncHandler(this, handleIntendedResult1, 1000, null, handleTimeout1);
		...
		{
			this.asyncFun2 = Async.asyncHandler(this, handleIntendedResult2,1000, null, handleTimeout2);
